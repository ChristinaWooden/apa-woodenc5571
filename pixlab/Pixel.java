...
public class Pixel
{
  ...
  public void setGrayAverage(){
    int n = (getRed() + getBlue() + getGreen()) / 3;
    setRed(n);
    setGreen(n);
    setBlue(n);
  }
  ...
  public void setGrayLightness(){
    ...
    colors.add(getBlue());
    colors.add(getGreen());
    setRed((Collections.max(colors) + Collections.min(colors))/2);
    setGreen((Collections.max(colors) + Collections.min(colors))/2);
    setBlue((Collections.max(colors) + Collections.min(colors))/2);
  }

  public void setGrayLuminosity(){
    int n = (getRed() + getBlue() + getGreen()) / 3;
    setRed((int)(getRed()*0.21) + (int)(getGreen()*0.72) + (int)(getBlue()*0.07));
    setGreen((int)(getRed()*0.21) + (int)(getGreen()*0.72) + (int)(getBlue()*0.07));
    setBlue((int)(getRed()*0.21) + (int)(getGreen()*0.72) + (int)(getBlue()*0.07));
  }
